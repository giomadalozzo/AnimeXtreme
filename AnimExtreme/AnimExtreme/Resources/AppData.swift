...
var shops: [Shop] = [Shop(id: 0, name: "Kitten", imgName: "shopKitten"),
                     Shop(id: 1, name: "Anime Play", imgName: "shopKitten"),
                     Shop(id: 2, name: "Minha Marcka", imgName: "shopKitten"),
                     Shop(id: 3, name: "Crazy Animes", imgName: "shopKitten"),
                     Shop(id: 4, name: "Fenix Rock Club", imgName: "shopKitten"),
                     Shop(id: 5, name: "Leco's Shouten", imgName: "shopKitten"),
                     Shop(id: 6, name: "Loja do Heroi", imgName: "shopKitten"),
                     Shop(id: 7, name: "FGTec", imgName: "shopKitten"),
                     Shop(id: 8, name: "Loja Anime Xtreme", imgName: "shopKitten"),
                     Shop(id: 9, name: "Pharaoh's Shop", imgName: "shopKitten")
]
